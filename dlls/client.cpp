...
void ClientPrecache()
{
	...
	PRECACHE_SOUND("debris/hits/hit_conc1.wav"); // hit concrete
	PRECACHE_SOUND("debris/hits/hit_conc2.wav");
	PRECACHE_SOUND("debris/hits/hit_conc3.wav");
	PRECACHE_SOUND("debris/hits/hit_conc4.wav");

	PRECACHE_SOUND("debris/hits/hit_metal1.wav"); // hit metal
	PRECACHE_SOUND("debris/hits/hit_metal2.wav");
	PRECACHE_SOUND("debris/hits/hit_metal3.wav");
	PRECACHE_SOUND("debris/hits/hit_metal4.wav");

	PRECACHE_SOUND("debris/hits/hit_wood1.wav"); // hit wood
	PRECACHE_SOUND("debris/hits/hit_wood2.wav");
	PRECACHE_SOUND("debris/hits/hit_wood3.wav");
	PRECACHE_SOUND("debris/hits/hit_wood4.wav");

	PRECACHE_SOUND("debris/hits/hit_glass1.wav"); // hit glass
	PRECACHE_SOUND("debris/hits/hit_glass2.wav");
	PRECACHE_SOUND("debris/hits/hit_glass3.wav");
	PRECACHE_SOUND("debris/hits/hit_glass4.wav");

	PRECACHE_SOUND("debris/hits/hit_tile1.wav"); // hit tile
	PRECACHE_SOUND("debris/hits/hit_tile2.wav");
	PRECACHE_SOUND("debris/hits/hit_tile3.wav");
	PRECACHE_SOUND("debris/hits/hit_tile4.wav");

	PRECACHE_SOUND("debris/hits/hit_dirt1.wav"); // hit dirt
	PRECACHE_SOUND("debris/hits/hit_dirt2.wav");
	PRECACHE_SOUND("debris/hits/hit_dirt3.wav");
	PRECACHE_SOUND("debris/hits/hit_dirt4.wav");

	PRECACHE_SOUND("debris/hits/hit_carpet1.wav"); // hit carpet
	PRECACHE_SOUND("debris/hits/hit_carpet2.wav");
	PRECACHE_SOUND("debris/hits/hit_carpet3.wav");
	PRECACHE_SOUND("debris/hits/hit_carpet4.wav");
