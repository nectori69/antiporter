...
//corresponds to sequences as laid out in the qc file
enum desert_eagle_e
{
...
void CDesertEagle::Precache()
{
	...
	//sounds
	PRECACHE_SOUND("weapons/deagle/deagle_fire.wav");
...
void CDesertEagle::Fire(float flSpread, float flCycleTime)
{
...
void CDesertEagle::WeaponIdle()
{
	...
	if (flRand <= 0.2)
	{
		//tl;dr, 76.0/30.0 is dividing the number of frames (76) by the frame-rate (30fps),
		//so that way you get how long the animation is gonna take! math is pretty neat i guess
