...
//below: added by SFS
#define STEP_CARPET 9	// carpet
#define STEP_WOOD 10	// wood
#define STEP_GRASS 11	// grass
...
void PM_AirAccelerate(Vector wishdir, float wishspeed, float accel)
{
	...
	// Cap it
	// 
	// ...but, juice it a ""little"" bit for those who like to go fast
	// EDIT: fuck the cap
	
	//if (accelspeed > addspeed * 8)
	//	accelspeed = addspeed * 8;
